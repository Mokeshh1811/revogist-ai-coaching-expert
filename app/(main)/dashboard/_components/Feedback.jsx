      ...
      return (
          <div>
              ...
              {discussionRoomList?.length === 0 && (
                  <h2>You don't have any previous Feedback</h2>
              )}
                      ...
                      (item, index) =>
                          (item.coachingOption === "Mock Interview" ||
                              ...
                              <div key={index} className='border-b-[1px] pb-3 mb-4 group flex justify-between items-center cursor-pointer'>
                                  ...
                                  <button className="px-4 py-2 border border-blue-500 text-blue-500 rounded hover:bg-blue-50 transition duration-200 invisible group-hover:visible">View Feedback</button>
                                  </Link>
                              </div>
                          )
                  )}
